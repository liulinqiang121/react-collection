<template>
  <div>
    <div class="content-body">
      ...
      <div class="bd-main">
        ...
        <el-form ref="conditionForm"  :model="conditionForm" :label-width="this.$util.LABEL_WIDTH" label-position="right"
          ...
          <div class="el-col fixed-width">
            <el-form-item label="委案时间" prop="CommitDate">
              <el-date-picker type="daterange" value-format="yyyy-MM-dd" format="yyyy/MM/dd" v-model="conditionForm.CommitDate" @change="commitDate" :disabled="timeDisabled"
        ...
        <!-- <el-table ref="multipleTable" height="500" :data="tb.data" tooltip-effect="dark" v-loading="loading" element-loading-text="拼命加载中" element-loading-spinner="el-icon-loading"
         ...
         <my-table ref="multipleTable" :tb="tb"  :loading="loading" @choose="handleSelectionChange" @sortChange="sortChange"></my-table>
    ...
    <allotCase :allotShow="allotShow" v-if="allotShow" :chooseDepartmentId="chooseDepartmentId" :selected="selected" :departments="departments" @allotClose="allotClose" @refreshList="refreshList"></allotCase>
  </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      handleSelectionChange(data) {
        ...
        data.forEach((row, index) => {
          ...
          this.chooseDepartmentId.push(row.departmentId)
        })
      },
    ...
    created() {
      ...
      var batchName = this.$route.query.batchName ? this.$util.decrypt(this.$route.query.batchName, 'batch'):'';
      ...
      if(type == 5 ) {
        ...
        var endData = moment().format('YYYY/MM/DD');
        this.conditionForm.CommitDate = [startDate,endData]
      }
