      ...
      <div class="bd-main">
        <el-form :inline="true" size="mini">
          ...
          <div>
            ...
            <el-date-picker size="mini" v-model="sendTime" start-placeholder="开始日期" end-placeholder="结束日期" type="daterange" @change="sendTimeChange"
        ...
        <el-table ref="multipleTable" height="650" :data="tb.data" tooltip-effect="dark" v-loading="loading" element-loading-text="拼命加载中"
          ...
          <el-table-column type="expand">
            <template slot-scope="props">
              <el-form label-position="left" inline class="form-detail">
                <el-form-item label="短信内容">
                  <span>{{ props.row.smsContent }}</span>
                </el-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      reset(conditionForm) {
        ...
        this.sendTime = []
        this.conditionForm.sendTimeMin = '';
        this.conditionForm.sendTimeMax = '';
        this.conditionForm.caseCode = '';
        this.lastWeek()
        this.searchForm = Object.assign({}, this.conditionForm)
        if (this.conditionForm.currentPage == 1) {
          this.getList(this.conditionForm);
      ...
      getdropdownData() {
        this.$axios.post('/api/assignee/smsRecord/getSearchInfo', {}).then((res) => {
          if (res.data.code == 0) {
      ...
      getList(data) {
        ...
        this.loading = true;
        this.$axios.post('/api/assignee/smsRecord/search', queryParams).then((res) => {
          if (res.data.code == 0) {
      ...
      today() {
        ...
        this.conditionForm.sendTimeMin = moment().format("YYYY-MM-DD")
        this.conditionForm.sendTimeMax = moment().format("YYYY-MM-DD");
        // this.getList();
      },
      ...
      yesterday() {
        ...
        this.conditionForm.sendTimeMin = moment().subtract(1, 'days').format("YYYY-MM-DD")
        this.conditionForm.sendTimeMax = moment().subtract(1, 'days').format("YYYY-MM-DD")
        // this.getList();
      },
      ...
      lastWeek() {
        ...
        this.conditionForm.sendTimeMin = moment().subtract(7, 'days').format("YYYY-MM-DD")
        this.conditionForm.sendTimeMax = moment().subtract(1, 'days').format("YYYY-MM-DD")
        // this.getList();
      },
      ...
      lastMonth() {
        ...
        this.conditionForm.sendTimeMin = moment().subtract(30, 'days').format("YYYY-MM-DD")
        this.conditionForm.sendTimeMax = moment().subtract(1, 'days').format("YYYY-MM-DD")
        // this.getList();
      },
      sendTimeChange(data) {
        ...
        if (!data) {
          ...
          this.conditionForm.sendTimeMin = data[0]
          this.conditionForm.sendTimeMax = data[1]
        }
