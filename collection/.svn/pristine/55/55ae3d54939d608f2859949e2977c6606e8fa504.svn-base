<template>
  <div class="content-body">
      ...
      <div class="table">
        <el-table ref="multipleTable" max-height="500" element-loading-text="拼命加载中" element-loading-spinner="el-icon-loading" :data="tb.data" tooltip-effect="dark"
          ...
          <el-table-column label="操作" align="center">
            ...
            <el-button size="mini" @click="deleteRule(scope)">删除</el-button> 
            </template> 
          </el-table-column>
        </el-table>
      </div>
    ...
    <!-- 添加规则 -->
    <outCallDialog  :visible="visible" @closeDialog="closeDialog" @refresh="refresh" v-if="visible"></outCallDialog >
  </div>
</template>
