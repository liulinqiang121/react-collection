        ...
        <div style="clear:both">
          <el-table ref="multipleTable" height="500" :data="tb.data" tooltip-effect="dark" v-loading="loading" element-loading-text="拼命加载中"
            ...
            <template slot-scope="scope">
              <el-button size="mini"  @click="showDetail(scope)">详情</el-button>
            </template>
          </el-table-column> 
          </el-table>
          <!-- <my-table :tb="tb"  :loading="loading" @choose="handleSelectionChange"></my-table> -->
        </div>
    ...
    methods: {
      ...
      distinctChange(index) {
        if(!index) {
          ...
          this.conditionForm.district = index.name;
        }
      },
      // 获取地址
