  ...
  <div class="content-body">
    ...
    <div class="bd-main">
      <el-form ref="conditionForm" :model="conditionForm" :label-width="this.$util.LABEL_WIDTH" label-position="right" class="condition-form"
          ...
          <el-form-item label="年龄">
            <el-col :span="11">
              <el-form-item label="" prop="borrowerAgeMin">
                <el-input v-model="conditionForm.borrowerAgeMin" clearable placeholder="最小值"></el-input>
              </el-form-item>
            </el-col>
            <el-col class="line" :span="2">-</el-col>
            <el-col :span="11">
              <el-form-item label="" prop="borrowerAgeMax">
                <el-input v-model="conditionForm.borrowerAgeMax" clearable placeholder="最大值"></el-input>
              </el-form-item>
            </el-col>
          </el-form-item>
        </div>
        ...
        <div class="el-col fixed-width" style="margin-left:-30px" v-if="dropdownData.isExpiredLabel">
          <el-form-item prop="isExpired">
           <el-checkbox v-model="isExpired"  @change="changeCheckbox">查看完结案件</el-checkbox>
          </el-form-item>
        </div>
      ...
      <!-- <el-table ref="multipleTable" height="460" @row-click="goCaseDetail" :data="tb.data" tooltip-effect="dark" v-loading="loading"
        element-loading-text="拼命加载中" element-loading-spinner="el-icon-loading" @selection-change="handleSelectionChange" empty-text="暂无数据" show-overflow-tooltip >
      ...
      <my-table ref="multipleTable" :tb="tb"  :loading="loading"  @sortChange="sortChange" @rowClick="goCaseDetail" @choose="handleSelectionChange"></my-table>
      <div>
          <el-row>
  ...
  export default {
    ...
    methods: {
      ...
      changeCheckbox(check) {
        if(check) {
          this.conditionForm.isExpired = 1;
        } else {
          this.conditionForm.isExpired = 0;
        }
        this.$axios.post('/api/assignee/collectionManage/getCaseStatus',{isExpired:this.conditionForm.isExpired})
          .then( res=> {
            if(res.data.code == 0) {
              this.dropdownData.caseStatus = res.data.data;
            }
          })
      },
