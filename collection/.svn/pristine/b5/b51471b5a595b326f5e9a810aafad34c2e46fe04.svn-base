<template>
  <div>
    ...
    <el-table ref="multipleTable" :data="justiceTb" tooltip-effect="dark" show-overflow-tooltip  v-loading="loading" element-loading-text="拼命加载中" element-loading-spinner="el-icon-loading"
      empty-text="暂无数据">
