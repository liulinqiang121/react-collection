      ...
      <div class="bd-main">
        <el-form ref="conditionForm" :model="conditionForm" :label-width="this.$util.LABEL_WIDTH"   label-position="right"
          ...
          <div class="el-col fixed-width">
              ...
              <el-cascader :options="dropdownData.department" change-on-select v-model="department" :props="departmentProps" @change="getDepartmentId" clearable>
              </el-cascader>
            </el-form-item>
          </div>
           <div class="el-col fixed-width">
            ...
            <el-form-item label="通话时间" prop="callTime" >
              <el-date-picker v-model="callTime" value-format="yyyy-MM-dd" format="yyyy/MM/dd" type="daterange"
                @change="callTimeChange" clearable>
              </el-date-picker>
            </el-form-item>
          </div> 
          <div class="el-col fixed-width">
        ...
        <el-table ref="multipleTable" height="600" :data="tb.data" tooltip-effect="dark" v-loading="loading" element-loading-text="拼命加载中" element-loading-spinner="el-icon-loading" @selection-change="handleSelectionChange">
          ...
          <el-table-column width="80" label="操作"  align="left" fixed="right" v-if="operationBtns[0].isShow && operationBtns[1].isShow">
            <template slot-scope="scope">
              <el-button size="mini" v-on:click.stop.prevent="playRecord(scope)" type="text" :class="scope.row.icon" v-if="operationBtns[0].isShow">
              </el-button>
