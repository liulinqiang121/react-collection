<template>
  <div>
    <el-dialog title='重置密码' :close-on-click-modal="false" :show-close="true" :visible.sync="passDialog" width="40%" :center="true"
      @close="close">
      <el-form ref='resetPass' :rules="rules" label-width="80px" size="small" :model="resetPass" class="dialog-main">
        <el-form-item label="新密码" prop="newPass">
          <el-input placeholder="请输入密码" v-model="resetPass.newPass"  :type="newType" oncopy="return false" onpaste="return false"
