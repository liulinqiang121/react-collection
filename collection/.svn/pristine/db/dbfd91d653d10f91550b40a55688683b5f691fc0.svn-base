  ...
  <div>
    <div class="content-body">
      ...
      <div class="bd-main">
        ...
        <el-table ref="multipleTable" :data="tb.data" tooltip-effect="dark" max-height="460" v-loading="loading" element-loading-text="拼命加载中"
          ...
          <el-table-column label="操作" width="150" fixed="right" align="center">
            <template slot-scope="scope">
              ...
              {code: "3", name: "已评价"}
              {code: "4", name: "已关闭"} -->
              <el-button size="mini" @click="openDetailDialog(operationBtns[0],scope.row)">查看详情</el-button>
            </template>
          </el-table-column>
        </el-table>
