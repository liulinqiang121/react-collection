...
" :key="item.uniqueId"></el-option>
        ...
        <el-form-item style="overflow: visible;">
          <el-row>
            <el-col  class="right i-icon">
            ...
            <el-col :span="14">
              <el-select value-key='uniqueId' v-model="phoneInfo" placeholder="请选择" size="mini" @change="optionChange" ref="phone" :error="error">
          ...
          <div class="el-form-item__error" style="right:0;left: unset;margin-top:-2px"  v-if="error">
            此号码已停催
          </div> 
        </el-form-item>
        <el-form-item label="家庭地址：" :class="userInfoBean.homeAddress ? 'normal':'empty'" >
          <!-- <span>{{userInfoBean.homeAddress | empty}}</span> -->
           <el-tooltip class="item" effect="dark" :content="userInfoBean.homeAddress" placement="top-start">
            <p>{{userInfoBean.homeAddress| empty}}</p>
          </el-tooltip>
          <!-- <el-tooltip class="item" effect="dark" :content="userInfoBean.homeAddress" placement="top-start">
            <span>{{userInfoBean.homeAddress | empty}}</span>
          </el-tooltip> -->
        ...
        <el-form-item label="常用地址：" :class="userInfoBean.usualAddress ? 'normal':'empty'" >
          ...
          <el-tooltip class="item" effect="dark" :content="userInfoBean.usualAddress | empty" placement="top-start">
            <p>{{userInfoBean.usualAddress | empty}}</p>
          </el-tooltip>
        </el-form-item>
        ...
        <el-form-item label="公司地址：" :class="userInfoBean.companyAddress ? 'normal':'empty'" >
          ...
          <el-tooltip class="item" effect="dark" :content="userInfoBean.companyAddress | empty" placement="top-start">
            <p>{{userInfoBean.companyAddress | empty}}</p>
          </el-tooltip>
        </el-form-item>
        ...
        <el-form-item label="其他地址：" :class="userInfoBean.otherAddress ? 'normal':'empty'" >
          ...
          <el-tooltip class="item" effect="dark" :content="userInfoBean.otherAddress | empty" placement="top-start">
            <p>{{userInfoBean.otherAddress | empty}}</p>
          </el-tooltip>
        </el-form-item>
