        ...
        <el-form :inline="true" size="mini" class="" :data="conditionForm" ref="conditionForm">
          ...
          <div>
            ...
            <el-form-item label="通话对象" prop="answering">
              <el-input v-model="conditionForm.answering" placeholder="" size="mini" clearable></el-input>
            </el-form-item>
            <el-form-item label="通话号码" prop="tel">
              <el-input v-model="conditionForm.tel" placeholder="" size="mini" clearable></el-input>
            </el-form-item>
            <el-form-item>
        ...
        <el-table ref="multipleTable" height="650" :data="tb.data" tooltip-effect="dark" v-loading="loading" element-loading-text="拼命加载中"
          ...
          <el-table-column width="80" label="操作" align="left" fixed="right">
            <template slot-scope="scope">
              ...
              <el-button size="mini" :disabled="scope.row.calledTime == 0 || scope.row.calledTime == null" v-on:click.stop.prevent="playRecord(scope)" type="text" :class="scope.row.icon">
              </el-button>
              <el-button size="mini" :disabled="scope.row.calledTime == 0 || scope.row.calledTime == null" v-on:click.stop.prevent="downloadRecord(scope)" type="text" class="el-icon-download">
              </el-button>
