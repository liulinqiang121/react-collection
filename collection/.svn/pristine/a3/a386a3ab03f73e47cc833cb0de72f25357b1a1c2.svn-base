<template>
  <div>
    <div class="content-body">
      ...
      <div class="bd-main">
        <el-table ref="multipleTable" :data="tb.data" tooltip-effect="dark" show-overflow-tooltip   max-height="460" v-loading="loading" element-loading-text="拼命加载中" element-loading-spinner="el-icon-loading" >
          ...
          <el-table-column label="操作" width="150"  fixed="right" align="center">
                  <template slot-scope="scope">
                     <span>
                       <el-button size="mini" @click="goAnnounceDetail(scope.row)">查看详情</el-button>
                    </span>
                </template>
          </el-table-column> 
        </el-table>
