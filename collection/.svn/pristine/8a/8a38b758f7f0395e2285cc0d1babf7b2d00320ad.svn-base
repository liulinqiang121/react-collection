  ...
  <div class="content-body">
    ...
    <div class="bd-main">
      ...
      <div style="margin:20px 0">规则状态筛选：  
        <el-radio-group v-model="checkboxModel" size="mini" @change="changeRadio" >
    ...
    <pagination :total="total" :pageSize="filterParams.pageSize" @changePage="changePage" :current-page="filterParams.currentPage" @changeSize="changeSize"></pagination>
    <!-- 添加 -->
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      // 改变页数
      changeSize(index) {
        this.filterParams.pageSize = index;
        this.getList();
      },
      // 在表格里面改变状态-类似编辑
      switchChange(val){
