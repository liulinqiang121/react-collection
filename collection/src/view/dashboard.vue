      ...
      <div class="bd-main">
        <el-row>
          <el-col :span="12">
            ...
            <div id="chart_hand_money" style="height:380px;"></div>
          </el-col>
          <el-col :span="12">
            <!-- <div ref="chart_hand_amount" style="height:380px;"></div> -->
            <div id="chart_hand_amount" style="height:380px;"></div>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <!-- <div ref="chart_age_money" style="height:380px;"></div> -->
            <div id="chart_age_money" style="height:380px;"></div>
          </el-col>
          <el-col :span="12">
            <!-- <div ref="chart_age_amount" style="height:380px;"></div> -->
            <div id="chart_age_amount" style="height:380px;"></div>
          </el-col>
        </el-row>
        <el-row>
          <!-- <div ref="chart_child_company" style="height:380px;"></div> -->
          <div id="chart_child_company" style="height:380px;"></div>
        </el-row>
      </div>
    </div>
  </div>
      ...
      this.$axios.post('/api/assignee/currentUser/getPageResourceByMenu', qs.stringify(param)).then(res => {
        if (res.data.code == 0) {
          switch (res.data.data[0].identifier) {
            case 'assignee_dashboard_company_data':
              // 总公司首页标识
              ...
              break;
            case 'assignee_dashboard_sub_company_data':
              // 分公司首页标识
              this.chartUrl = '/api/assignee/homePage/getChartDataForSubcompany';
              this.formUrl = '/api/assignee/homePage/getBaseDataForSubcompany';
              this.dropdownUrl = '/api/assignee/homePage/getSearchInfoForSubCompany'
              break;
            case 'assignee_dashboard_person_data':
              // 个人首页标识
          ...
          if (this.chartUrl) {
            this.$nextTick(function(){
              this.chart_hand_money = echarts.init(document.getElementById('chart_hand_money'))
              this.chart_hand_amount = echarts.init(document.getElementById('chart_hand_amount'))
              this.chart_age_money = echarts.init(document.getElementById('chart_age_money'))
              this.chart_age_amount = echarts.init(document.getElementById('chart_age_amount'))
              this.chart_child_company = echarts.init(document.getElementById('chart_child_company'))
              this.getchartData()
            })
...
<style lang="scss">
  ...
  .month-item {
    padding: 0 31% 21px 12%; // border-bottom: 1px solid #eeeeee;
    .item-title {
      font-size: 12px;
      color: #222222;
      margin-bottom: 20px;
