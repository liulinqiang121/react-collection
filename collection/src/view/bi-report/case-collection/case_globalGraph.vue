<template>
  <div class="content-body">
    ...
    <div class="bd-main">
      ...
      <p class="exportTable"><a class="el-icon-upload2" @click="downloadTable(0)">导出EXCEL文件</a></p>
      ...
      <div>
        ...
        <p class="exportTable"><a class="el-icon-upload2" @click="downloadTable(1)">导出EXCEL文件</a></p>
  ...
  export default {
    ...
    methods: {
      ...
      downloadTable(index) {
        var url,data;
        if(!index) {
          url = '/api/assignee/caseCollection/whole/getBatchTimesDataDownload';
          data = {
            countDateMin: this.countDateMin,
            countDateMax: this.countDateMax,
            batchTimes: this.hand
          ...
          url = '/api/assignee/caseCollection/whole/getReceivableAgeDataDownload';
          data = {
            countDateMin: this.countDateMin,
            countDateMax: this.countDateMax,
            receivableAge: this.age
