  ...
  <div class="infos" >
    ...
    <div class="info">
      ...
      <el-form inline class="form-detail condition-form" label-position="right">
        ...
        <el-form-item label="委案金额：" :class="debtInfoBeans.commitMoney  ? 'expressive':'empty'">
          <span>{{ debtInfoBeans.commitMoney | empty}}</span>
        </el-form-item>
        <el-form-item label="最新欠款金额：" :class="debtInfoBeans.latestDebtMoney  ? 'expressive':'empty'">
        ...
        <el-form-item label="已还款总额：" :class="debtInfoBeans.totalRepayMoney  ? 'expressive':'empty'">
    ...
    <div class="info">
      ...
      <el-form inline class="form-detail condition-form" label-position="right">
        ...
        <el-form-item label="案件标签：" :class="caseInfoBeans.caseLabel  ? 'expressive':'empty'">
  ...
  export default {
    ...
    methods: {
     ...
     // 文本发送QQ
      ...
      // 下拉默人选择第一个
      refreshInfo(userInfoBean,stopList) {
        this.userInfoBean = userInfoBean;
        this.username = this.userInfoList.length>1? userInfoBean.borrowerName+'（'+userInfoBean.contactRelation+'）': userInfoBean.borrowerName;
        setTimeout( ()=>{
          this.username = this.userInfoList.length>1? userInfoBean.borrowerName+'（'+userInfoBean.contactRelation+'）': userInfoBean.borrowerName;
        },0)  
        ...
        this.stopList && this.userInfoBean.listPhone[0] && Array.includes(stopList,this.userInfoBean.listPhone[0] )?this.error = true:this.error = false;
