  ...
  <div>
    ...
    <div class="content-body">
      ...
      <div class="bd-main">
        ...
        <el-table ref="multipleTable"  @sort-change="sortChange"  :data="tb.data" height="460" tooltip-effect="dark" v-loading="loading" element-loading-text="拼命加载中"
          element-loading-spinner="el-icon-loading" @selection-change="handleSelectionChange" show-overflow-tooltip >
          <el-table-column type="selection" width="50"></el-table-column>
          <el-table-column v-for="field in tb.fields" :align="field.align||'center'" :sortable="field.sortable" :prop="field.key" :label="field.label" :width="field.width"
            :key="field.id">
    ...
    <el-dialog :title="title" :visible.sync="visible" :close-on-click-modal="false" @close="close">
      ...
      <div class="dialog_submit">
        ...
        <el-button type="primary" @click.native.prevent="dialogSubmitHandle" size="small">提交</el-button>
      </div>
    </el-dialog>
  </div>
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      this.getRuleList();
      this.getApartment();
      this.conditionForm.proCallStatus = 0
    },
    data() {
    ...
    //   },
      ...
      // 停止外呼
      stopCalling() {
        this.$confirm('当前操作将取消案件相关的所有外呼任务，是否继续','提示',{
            confirmButtonText: '确定',
            cancelButtonText: '取消',
            type: 'warning'
          })
