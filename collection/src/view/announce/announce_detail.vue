          ...
          <el-row :gutter="10">
              <el-col :span="10">
                  ...
                  <el-form-item label="附件" prop="">
                    <p v-for="(item,index) in this.detailForm.accessory">
                      <a href="javascript:void(0)"  @click="downLoad(item)" style="text-decoration:underline;" class="el-button--text el-button--small"  :key="item.id"> {{index+1}}. {{item.name}}</a>
                    </p>
                  </el-form-item>
                  </el-col>
              <el-col :span="14">
