      ...
      <div class="upload_content">
        ...
        <el-upload :multiple="false" :on-exceed="handleExceed" class="upload-demo"   ref="importCase"
         action="/api/assignee/alarmWord/inport" :data="postData" :on-success="handleSuccess_importCase" :on-error="handleError" :on-change="handleChange"
          ...
          <el-input placeholder="请选择文件" v-model="filename" slot="trigger"  :readonly="true" size="small">
          </el-input>
        ...
        <div style="padding-left: 230px;">
          <el-button type="text">
            <a href="/api/assignee/alarmWord/templetExport"   >模板下载</a>
          </el-button>
        </div>
        <span class="result-upload error-result">{{result}}</span>
      </div>
      <div class="dialog-footer">
        <el-button type="primary" @click.native.prevent="submitUpload" size="small">上传</el-button>
         <el-button  @click="reset" size="small">取消</el-button>
      </div>
    </el-dialog>
  </div>
</template>
