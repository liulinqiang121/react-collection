...
<div>
  <div v-if="!allotPage">
    ...
    <allotCase :allotShow="allotShow" :selected="selected" :chooseDepartmentId="chooseDepartmentId"  :departments="departments" @allotClose="allotClose" @refreshList="refreshList"></allotCase>
