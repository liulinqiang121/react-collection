...
// 9.9 催收员外访情况查询
const outvisit_inquiries = r => require.ensure([], () => r(require('@/view/bi-report/kpi/outvisit_inquiries')), 'outvisit_inquiries')
  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: '/assignee_outvisit_inquiries',
          name: '催收员外访情况查询',
          component: outvisit_inquiries,
          meta: {
            requireAuth: true
          }
        },
